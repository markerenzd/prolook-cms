...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="softball-uniform" class="container-sports small-up-2 wow fadeIn clearfix "> 
			<?php

	 		   $baseball_uniform = new WP_Query( array( 'post_type' => 'softball_uninform','posts_per_page' => 100, 'order' => 'ASC'));	
				while ( $baseball_uniform ->have_posts() ) : $baseball_uniform ->the_post();
...
<?php else: ?>
	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="softball-uniform" class="container-sports small-up-1 medium-up-2 large-up-3 wow fadeIn clearfix "> 
			<?php
