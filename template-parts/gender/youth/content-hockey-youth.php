...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="baseball-uniform" class="container-sports small-up-2 wow fadeIn clearfix "> 
	 	   ...
	 	   $hockey_uniform  = new WP_Query( array( 
	 		   		'post_type' 		=> 'hockey_uniform ',
	 		   		'posts_per_page' 	=> -1, 
	 		   		'order' 			=> 'ASC',
	 		   		'tax_query' 		=> array(
			 		   					array (
				...
				while ( $hockey_uniform ->have_posts() ) : $hockey_uniform ->the_post();
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="hockey_uniform" class="container-sports small-up-1 medium-up-2 large-up-3 wow fadeIn clearfix "> 
			<?php
		 	   $hockey_uniform  = new WP_Query( array( 
		 		   		'post_type' 		=> 'hockey_uniform ',
		 		   		'posts_per_page' 	=> -1, 
