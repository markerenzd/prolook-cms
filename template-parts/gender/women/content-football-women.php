...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	?>
		<div id="filter-menu">
			<ul id="category-menu">
					<li id="btn-all-football-women">
				   		 <a href="#">All</a>
				    </li>
			    <?php foreach ( $categories as $cat ) : ?>
				    <li id="cat-<?php echo $cat->term_id ?>" class="gender-women-btn">
				   		 <a class="<?php echo $cat->slug; ?> ajax" data-gender-women="<?php echo $cat->term_id; ?> " href="#"><?php echo $cat->name; ?></a>
				    </li>
				    <?php //print_r2($cat); ?>
			    <?php endforeach; ?>
			</ul>
		...
		<div id="footaball-uniform-filter-women" class="container-sports small-up-1 medium-up-2 large-up-3 fadeIn clearfix ">
