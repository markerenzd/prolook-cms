	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="baseball-uniform" class="container-sports small-up-2 wow fadeIn clearfix "> 
			<?php
	 		   ...
	 		   $baseball_uniform = new WP_Query( array( 'post_type' => 'baseball_uniform','posts_per_page' => 100, 'order' => 'ASC'));	
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="item-wrapper" class="large-12 medium-12 columns" >
		<div id="baseball-uniform" class="container-sports small-up-1 medium-up-2 large-up-3 wow fadeIn clearfix "> 
			<?php
